...
public class AuthConfigFactory {
     ...
     */
    public AuthConfig createAuthConfig(boolean isPush, boolean skipExtendedAuth,
                                       Map authConfig, Settings settings,
                                       String user, String registry)
    ...
    private AuthConfig createStandardAuthConfig(boolean isPush, Map authConfigMap, Settings settings, String user, String registry)
        ...
        if (ret != null) {
            log.debug("AuthConfig: found credentials in ~/.m2/setting.xml");
            return ret;
        }
